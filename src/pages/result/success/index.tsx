...
const content = (
  <>
    ...
    >
      <Descriptions.Item
        label={<FormattedMessage id="resultandsuccess.success.operate-id" defaultMessage="Project ID：" />}
      >
        23421
      </Descriptions.Item>
      <Descriptions.Item
      ...
      <Descriptions.Item
        label={<FormattedMessage id="resultandsuccess.success.operate-time" defaultMessage="Effective time：" />}
      >
    ...
    <Steps progressDot current={1}>
      ...
      <Step
        title={
          <span style={{ fontSize: 14 }}>
            <FormattedMessage id="resultandsuccess.success.step3-title" defaultMessage="Financial review" />
          </span>
        }
      />
      <Step
